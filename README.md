...
The Disclosure is organized into a predefined data schema and MUST be cryptographically signed using SHA3-512 hash. The integrity hash MUST be appended to a disclosure as OETP.shcema.integrity lement.

### Storage

Both the signature integrity hash and the Disclosure is be stored in the log-centric Open Ethics database and MAY be mirrored by other distributed databases for redundancy and safety.
...
```javascript
{
    "schema": {
        ...
        "version": "0.9.2 RFC",
        "integrity": "cc3178c485a163921e35323cfcc5a3912befc1ba48a79a6d2741f2e363108646754f33354de5fd70327fd9f73f40324bae514235d4fcdf7f496995e9394ed890"
    },
    "snapshot": {
        "product": {
            "url": "thisisatest.com",
